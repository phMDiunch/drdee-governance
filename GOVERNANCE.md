...
03-van-hanh/             SOP vận hành theo bộ phận (gồm y-khoa: an toàn y tế, nhiễm khuẩn, bức xạ, tai biến, thuốc/vật tư)
...
1. `02-nhan-su`
2. `03-van-hanh` (gồm **y-khoa: an toàn y tế** — bắt buộc pháp lý, có thể kéo lên sớm; marketing & CSKH bổ sung)
3. `04-tai-chinh`
4. `08-du-lieu-va-he-thong`
5. `06-dao-tao`
7. `07-phap-ly-va-tuan-thu`
8. `05-van-ban-hanh-chinh` hoàn thiện dần

Chi tiết theo đợt A–G: xem `00-meta/phan-tich-thieu-va-ke-hoach.md`.
